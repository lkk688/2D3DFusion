...
from KittiSemantic.dataset import collate_fn_BEV, collate_fn_BEV_test, SemKITTI, spherical_dataset, voxel_dataset
...
def main(args):
    ...
    # prepare miou fun
    unique_label=np.asarray(sorted(list(SemKITTI_label_name.keys())))[1:] - 1 #19
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data_dir', default='/DATA8T/Datasets/KittiSemantic/dataset')
    parser.add_argument('-p', '--model_save_path', default='pretrained_weight/SemKITTI_trad_BEVSeg.pt') #SemKITTI_PolarSeg.pt
    parser.add_argument('-o', '--test_output_path', default='/DATA8T/Datasets/KittiSemantic/out/SemKITTI_test')
