...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='mydetector3d/tools/cfgs/kitti_models/voxelnext.yaml', help='specify the config for training')
    ...
    parser.add_argument('--extra_tag', type=str, default='0420', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str, default='output/kitti_models/voxelnext/0420/ckpt/checkpoint_epoch_128.pth', help='checkpoint to start from')
