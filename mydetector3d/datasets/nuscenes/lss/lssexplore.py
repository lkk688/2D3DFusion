...
if __name__ == '__main__':
    ...
    viz_model_preds('mini', model_path, 
                    ...
                    map_folder='/data/cmpe249-fa22/nuScenes/nuScenesv1.0-mini/', gpuid=0)
    ...
    lidar_check('mini', dataroot='/data/cmpe249-fa22/nuScenes/nuScenesv1.0-mini/', show_lidar=True, viz_train=False)