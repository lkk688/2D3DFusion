#ref: https://github.com/nv-tlabs/lift-splat-shoot/blob/master/src/explore.py
...
from mydetector3d.datasets.nuscenes.lss.lssdata import compile_data
from mydetector3d.datasets.nuscenes.lss.lsstools import (ego_to_cam, get_only_in_img_mask, denormalize_img,
                    SimpleLoss, get_val_info, add_ego, gen_dx_bx,
                    get_nusc_maps, plot_nusc_map)
from mydetector3d.datasets.nuscenes.lss.lssmodels import compile_model
    ...
    for epoch in range(nepochs):
        for batchi, (imgs, rots, trans, intrins, post_rots, post_trans, pts, binimgs) in enumerate(loader):
            ...
            for si in range(imgs.shape[0]):
                ...
                print('saving', imname)
                plt.savefig(Path(output_folder)/imname)
...
#/data/cmpe249-fa22/Mymodels/lss_model525000.pt
import os
if __name__ == '__main__':
    os.environ['TORCH_HOME'] = '/data/cmpe249-fa22/torchhome/'
    DATAPATH='/data/cmpe249-fa22/torchvisiondata'
    model_path='/data/cmpe249-fa22/Mymodels/lss_model525000.pt'
    #model_path='output/model8000.pt'

    #src.explore.eval_model_iou
    #Evaluate the IOU of a model on the nuScenes validation set.
    eval_model_iou('mini', model_path, dataroot='/data/cmpe249-fa22/nuScenes/nuScenesv1.0-mini/', gpuid=0)

    viz_model_preds('mini', model_path, 
                    dataroot='/data/cmpe249-fa22/nuScenes/nuScenesv1.0-mini/', 
                    map_folder='/data/cmpe249-fa22/nuScenes/nuScenesv1.0-mini/', 
                    output_folder='/data/cmpe249-fa23/trainoutput/lss', gpuid=0)
    ...
    lidar_check('mini', dataroot='/data/cmpe249-fa22/nuScenes/nuScenesv1.0-mini/',
                output_folder='/data/cmpe249-fa23/trainoutput/lss',
                show_lidar=True, viz_train=False)