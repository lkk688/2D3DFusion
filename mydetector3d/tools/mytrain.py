...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='mydetector3d/tools/cfgs/waymokitti_models/my3dmodel.yaml', help='specify the config for training')
    ...
    parser.add_argument('--extra_tag', type=str, default='0505', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str, default='/data/cmpe249-fa22/Mymodels/waymokitti_models/my3dmodel/0505/ckpt/latest_model.pth', help='checkpoint to start from')
